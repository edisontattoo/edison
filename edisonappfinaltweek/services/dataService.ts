...
export const initializeData = () => {
    ...
    if (!localStorage.getItem(SETTINGS_KEY)) {
        setData(SETTINGS_KEY, {
            ...
            // Change these via Admin → Settings after first login.
            // These are NEVER enforced on existing data (no override block).
            credentials: { user: 'admin@yourstudio.com', pass: 'ChangeMe#2024' },
...
I agree to follow all instructions concerning the care of my tattoo/piercing while it is healing. I understand that failure to do so may increase my risk of complications and that [STUDIO NAME] and its artists are not responsible for any issues arising from my failure to follow these aftercare instructions.
...
I hereby release and forever discharge [STUDIO NAME], its owners, artists, employees, and agents from any and all claims, damages, or legal actions arising from or connected in any way with my tattoo/piercing or the procedures and conduct used in performing my tattoo/piercing, to the fullest extent allowed by law.

PHOTO RELEASE (Optional): If I have checked the "Photo Release Consent" box, I consent to the taking of photographs or videos of my tattoo/piercing and grant [STUDIO NAME] the right to use these for promotional purposes, including but not to social media, websites, and print advertising, without compensation.
...
`,
            ...
            submissionEmail: 'info@yourstudio.com'
        });
    }
};
